...
#
#     PHX_SERVER=true bin/git_beholder start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :git_beholder, GitBeholderWeb.Endpoint, server: true
end

if config_env() == :prod do
  database_path = System.get_env("DATABASE_PATH") || "git_beholder.db"
  ...
  #
  #     config :git_beholder, GitBeholder.Mailer,
